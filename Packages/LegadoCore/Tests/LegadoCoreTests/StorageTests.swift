...
final class StorageTests: XCTestCase {
    ...
    func testBaselineSchemaAndIndexes() throws {
        ...
        try database.writer.read { db in
            ...
            XCTAssertEqual(Set(indexes), Set(["index_books_name_author", "index_chapters_bookUrl", "index_chapters_bookUrl_index", "index_book_sources_bookSourceUrl", "index_searchBooks_bookUrl", "index_searchBooks_origin", "index_replace_rules_id", "index_cookies_url", "index_readRecord_snapshot", "index_bookmarks_bookName_bookAuthor", "index_highlights_bookUrl", "index_auto_task_rules_order", "index_highlightRules_uuid"]))
