...
/// Kotlin cb664b84d: app/src/main/java/io/legado/app/data/entities/rule/ExploreRule.kt.
public struct ExploreRule: Codable, Equatable, GsonRule {
    /// Kotlin 默认值：`null`（ExploreRule.kt:13）。
    public var bookList: String? = nil
    /// Kotlin 默认值：`null`（ExploreRule.kt:14）。
    public var name: String? = nil
    /// Kotlin 默认值：`null`（ExploreRule.kt:15）。
    public var author: String? = nil
    /// Kotlin 默认值：`null`（ExploreRule.kt:16）。
    public var intro: String? = nil
    /// Kotlin 默认值：`null`（ExploreRule.kt:17）。
    public var kind: String? = nil
    /// Kotlin 默认值：`null`（ExploreRule.kt:18）。
    public var lastChapter: String? = nil
    /// Kotlin 默认值：`null`（ExploreRule.kt:19）。
    public var updateTime: String? = nil
    /// Kotlin 默认值：`null`（ExploreRule.kt:20）。
    public var bookUrl: String? = nil
    /// Kotlin 默认值：`null`（ExploreRule.kt:21）。
    public var coverUrl: String? = nil
    /// Kotlin 默认值：`null`（ExploreRule.kt:22）。
