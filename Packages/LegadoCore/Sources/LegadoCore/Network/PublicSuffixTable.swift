...
// 源文件 SHA-256: 4b673689999dbaca60b93fa3e1da5752505ef9717b1c4dc44acbfdafd35679ea
enum PublicSuffixTable {
    static let exact: Set<String> = Set("""
    0.bg
    0am.jp
    0g0.jp
    0j0.jp
    ...
    zw
    """.split(separator: "\n").map(String.init))
    static let wildcard: Set<String> = Set("""
    ...
    zerops.zone
    """.split(separator: "\n").map(String.init))
    static let exception: Set<String> = Set("""
    city.kawasaki.jp
    city.kitakyushu.jp
    city.kobe.jp
    city.nagoya.jp
