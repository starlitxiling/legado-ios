...
<task>
目标：只读复审阶段 4 单元 B9「阅读器进阶」的未提交改动（git diff HEAD 与未跟踪文件中属于 B9 的部分），对照 Kotlin（commit cb664b84d，只读，前缀 /Users/wujie/Work/legado-ios/app/src/main/java/io/legado/app/）找出与 Android 行为不一致、逻辑错误、并发 / 生命周期缺陷、测试固化错误期望的问题。工作目录 /Users/wujie/Work/legado-ios/.claude/worktrees/ios。
